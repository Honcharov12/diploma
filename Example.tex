...
\renewcommand\subsection{\addtocontents{toc}{\protect\addvspace{10\p@}}%
  \@startsection {subsection}{1}{\z@}%
  {-3.5ex \@plus -1ex \@minus -.2ex}%
  {2.3ex \@plus.2ex}%
  {\normalfont\Large\bfseries}}
\renewcommand\subsubsection{\addtocontents{toc}{\protect\addvspace{10\p@}}%
...
%\titleformat{\anonsection}{\bfseries}{}{12.5mm}
...
%\renewcommand\cftcafterpnum{\vskip15pt}
...
\def\tablename{\hspace{1.2cm}Таблиця}
