%\anonsection{Перелік познак та скорочень}
%\anonsection{\fontfamily{ptm}\selectfont\itshape ПЕРЕЛІК ПОЗНАК ТА СКОРОЧЕНЬ}

\begin{center}
\textbf{ПЕРЕЛІК ПОЗНАК ТА СКОРОЧЕНЬ}
\end{center}
\addcontentsline{toc}{section}{Перелік познак та скорочень}
